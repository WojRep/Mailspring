  ...
  onError({ key, debuginfo }: { key: string; debuginfo: string }) {
    ...
    if (key === 'no-sent-folder') {
      ...
      errorDetail = localized(
        'In order to send mail through ActunaMail, your email account must have a Sent Mail folder. You can specify a Sent folder manually by visiting Preferences > Folders and choosing a folder name from the dropdown menu.'
      );
      ...
      errorDetail = localized(
        'In order to send mail through ActunaMail, your email account must have a Trash folder. You can specify a Trash folder manually by visiting Preferences > Folders and choosing a folder name from the dropdown menu.'
      );
      ...
      errorMessage = localized(
        `Sorry, ActunaMail was unable to deliver this message: %@`,
