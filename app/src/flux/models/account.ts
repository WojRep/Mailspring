...
/*
 * Public: The Account model represents a Account served by the ActunaMail Platform API.
 * Every object on the ActunaMail platform exists within a Account, which typically represents
 * an email account.
 *
 * ## Attributes
 *
