...
import { Listenable } from 'actunamail-store';
...
ActunaMail is a multi-window application. The `scope` of an Action dictates
...
/*
  Public: Fired when the ActunaMail API Connector receives new data from the API.
...
/*
  Public: Manage the ActunaMail identity (legacy — dead-code post PRO removal)
  */
export const logoutActunaMailIdentity = create('logoutActunaMailIdentity', ActionScopeWindow);
