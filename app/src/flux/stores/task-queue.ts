...
import { Rx } from 'actunamail-exports';
...
The TaskQueue is essential to offline mode in ActunaMail. It automatically pauses
...
even if the user quits ActunaMail.
...
class TaskQueue extends ActunaMailStore {
  _queue: Task[] = [];
  _completed: Task[] = [];
