import { Message, Contact } from 'actunamail-exports';
...
export class ComposerExtension {
  ...
  */
  ...
  //
  // - `iconUrl`: The url of your icon. It should be in the `actunamail://`
  // scheme.  For example: `actunamail://your-package-name/assets/my-icon@2x.png`.
