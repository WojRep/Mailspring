...
import { Actions, Calendar, DatabaseStore, DateUtils, localized } from 'actunamail-exports';
...
> {
  ...
  createEvent = async ({
    ...
    const disabledCalendars: string[] = AppEnv.config.get('actunamail.disabledCalendars') || [];
