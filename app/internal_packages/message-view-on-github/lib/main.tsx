...
This is the entry point of an ActunaMail package. All packages must have a file
called `main` in their `/lib` folder.

The `activate` method of the package gets called when it is activated.
This happens during ActunaMail's bootup. It can also happen when a user manually
enables your package.

Nearly all ActunaMail packages have similar `activate` methods. The most common
...
Pre-enabled packages get activated on ActunaMail bootup. They can also be
