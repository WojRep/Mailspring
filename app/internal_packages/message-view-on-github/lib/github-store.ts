...
class GithubStore extends ActunaMailStore {
  _link: string = null;
  _lastItemIds: string[];
  ...
  // All {ActunaMailStore}s ONLY have reader methods. No setter methods. Use an
  // `Action` instead!
  //
...
All {ActunaMailStore}s are constructed upon their first `require` by another
