...
import { localized, PropTypes, Thread } from 'actunamail-exports';
import { RetinaImg, KeyCommandsRegion } from 'actunamail-component-kit';
...
Unlike a traditional React application, ActunaMail components have very few
...
not what React components should be doing. In ActunaMail a component's only
...
> {
  ...
  componentDidMount() {
    /*
     * The `listen` method of {ActunaMailStore}s (which {GithubStore}
  ...
  /** ** Super common ActunaMail Component private methods ****
  /*
  * An extremely common pattern for all ActunaMail components are the methods
