...
// (It can verify the connection is secure, but not that the receiving party is /this/ copy of ActunaMail.)
//
// Note: This is not a security risk for the end-user -- it just means someone could "fork" ActunaMail and re-use it's
