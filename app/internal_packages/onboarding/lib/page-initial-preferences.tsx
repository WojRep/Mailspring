...
> {
  ...
  render() {
    ...
    return (
      <div className="page opaque" style={{ width: 900, height: 620 }}>
        <h1 style={{ paddingTop: 100 }}>{localized(`Welcome to ActunaMail`)}</h1>
  ...
  _onFinished = () => {
    // WS1-E: there is no Pro tier in Actuna Mail. The upstream behaviour
    // routed non-Pro users to the 'initial-subscription' upgrade pitch;
    // we go straight to a successful account setup.
