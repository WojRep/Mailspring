import { localized, localizedReactFragment, React } from 'actunamail-exports';
  ...
  },
  {
    ...
    note: (
      <span>
        ...
        {localizedReactFragment(
          'Yahoo requires that you create a unique app password for email apps like ActunaMail. Follow %@ to create one and then paste it below.',
          <a
  ...
  },
  {
    ...
    note: (
      <span>
        <strong>{localized('Important')}:</strong>{' '}
        {localizedReactFragment(
          'iCloud requires that you create a unique app password for email apps like ActunaMail. Follow %@ to create one and then paste it below.',
  ...
  },
  {
    ...
    note: (
      <span>
        <strong>{localized('Important')}:</strong>{' '}
        {localizedReactFragment(
          'FastMail requires that you create a unique app password of type IMAP for email apps like ActunaMail. Follow %@ to create one and then paste it below.',
          <a
            style={{ fontWeight: 600 }}
  ...
  },
  {
    ...
    note: (
      <span>
        ...
        <strong>{localized('Important')}:</strong>{' '}
        {localizedReactFragment(
          'GMX requires that you %@ before using email clients like ActunaMail.',
  ...
  },
  {
    ...
    note: (
      <span>
        <strong>{localized('Important')}:</strong>{' '}
        {localizedReactFragment(
          'You must %@ and you may need to %@ to connect to your Yandex account. If you use two-factor auth, you must create an %@ for ActunaMail.',
