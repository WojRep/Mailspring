# Darkside
**A dark sidebar theme for ActunaMail. Created by [Jamie Wilson](http://jamiewilson.io)**

#### Customize

> **Open the theme directory**  
> If you're on a Mac, you can find the theme files at `~/Library/Application Support/ActunaMail/packages`. To get there quickly, use the key command <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>G</kbd> and enter `~/Library/Application Support/ActunaMail/packages`.
