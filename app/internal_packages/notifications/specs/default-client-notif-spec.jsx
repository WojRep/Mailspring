...
describe('DefaultClientNotif', function DefaultClientNotifTests() {
  ...
  describe("when ActunaMail isn't the default mail client", () => {
    beforeEach(() => {
    ...
    describe('when the user has yet to respond', () => {
      ...
      it('allows the user to set ActunaMail as the default client', () => {
        let scheme = null;
        stubRegister = urlScheme => {
          scheme = urlScheme;
        };
  ...
  describe('when ActunaMail is the default mail client', () => {
    let container;
    beforeEach(() => {
