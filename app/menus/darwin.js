  ...
  menu: [
    {
      ...
      label: 'ActunaMail',
      submenu: [
        { label: localized('About ActunaMail'), command: 'application:about' },
        ...
        { type: 'separator' },
        { label: localized('Hide ActunaMail'), command: 'application:hide' },
...

    {
      ...
      submenu: [
        { label: localized('ActunaMail Help'), command: 'application:view-help' },
        { type: 'separator' },
        { label: localized('Getting Started Guide'), command: 'application:view-getting-started' },
        { label: localized('ActunaMail Community'), command: 'application:view-community' },
      ],
    },
  ],
};
