...
import { Contact } from 'actunamail-exports';
import { KeyCommandsRegion, TokenizingTextField, Menu } from 'actunamail-component-kit';
...
const participant2 = new Contact({
  id: '2',
  email: 'burgers@actunamail.test',
  name: 'ActunaMail Burger Basket',
  hidden: false,
  source: 'mail',
});
  ...
  describe('when the user drags and drops a token between two fields', () =>
    it('should work properly', function () {
      ...
      expect(dragStartEventData).toEqual({
        'actunamail-token-items':
          '[{"id":"2","name":"ActunaMail Burger Basket","h":false,"s":"mail","email":"burgers@actunamail.test","gis":[],"__cls":"Contact"}]',
        'text/plain': 'ActunaMail Burger Basket <burgers@actunamail.test>',
      });
