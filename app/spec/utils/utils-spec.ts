  ...
  describe('modelTypesReviver', function () {
    ...
    it('should serialize and de-serialize models correctly', function () {
      const expectedString =
        '[{"id":"local-1","aid":"1","metadata":[],"subject":"Test 1234","categories":[],"participants":[{"id":"local-a","aid":"1","name":"Juan","h":false,"s":"mail","email":"juan@actunamail.test","gis":[],"__cls":"Contact"},{"id":"local-b","aid":"1","name":"Ben","h":false,"s":"mail","email":"ben@actunamail.test","gis":[],"__cls":"Contact"}],"__cls":"Thread"}]';
    ...
    it("should re-inflate Models in places they're not explicitly declared types", function () {
      ...
      const expectedString =
        '{"id":"ThreadsToProcess","json":[{"id":"local-1","aid":"1","metadata":[],"subject":"Test 1234","categories":[],"participants":[{"id":"local-a","aid":"1","name":"Juan","h":false,"s":"mail","email":"juan@actunamail.test","gis":[],"__cls":"Contact"},{"id":"local-b","aid":"1","name":"Ben","h":false,"s":"mail","email":"ben@actunamail.test","gis":[],"__cls":"Contact"}],"__cls":"Thread"}]}';
